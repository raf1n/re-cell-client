        ...
        <div className="flex flex-col items-center mx-12 lg:mx-0">
          <div className="relative text-center">
            ...
            <p className="px-6 py-1 text-lg italic">
              reCell has been a fantastic startup that has brought so much value
              to the customer. Buyers get better exchange value for phones!
            </p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
          ...
          <span className="w-12 h-1 my-2 rounded-lg bg-gray-700"></span>
          <p>Herok Raja</p>
        </div>
        <div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
          <div className="relative text-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              className="absolute top-0 -left-4 w-8 h-8 text-gray-300"
            >
              <path
                fill="currentColor"
            ...
            <p className="px-6 py-1 text-lg italic">
              I highly recommend reCell in a book I just wrote called How to
              De-clutter and Make Money Now. You rock!
            </p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
